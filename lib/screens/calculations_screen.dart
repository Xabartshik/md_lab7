...
import 'package:lab6/models/weather_model.dart';
...
class _CalculationsScreenState extends State<CalculationsScreen> {
  ...
  String _calculateComfort(double temperature, double humidity) {
    if (humidity < 30) return 'Слишком Улан Удэ';
    if (humidity > 70) return 'Слишком Питер';
    if (temperature < 18) return 'Слишком Норильск';
    if (temperature > 26) return 'Слишком Чита летом';
    return 'Вот он, родной Урюпинск!';
  }
